...
public interface Option9<A extends T, B extends T, C extends T, D extends T,
    ...
    Option9<AA, BB, CC, DD, EE, FF, GG, HH, II, TT> thenOptions(Function<A, AA> f1, Function<B, BB> f2,
        ...
        switch (index()) {
            ...
            case 8: return Options.value9(f9.apply(value9()));
            default: return null;
        }
    }
}
